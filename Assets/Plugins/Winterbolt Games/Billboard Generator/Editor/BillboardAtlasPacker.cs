...
namespace WinterboltGames.BillboardGenerator.Editor
{
	internal sealed class BillboardAtlasPacker : EditorWindow
	{
		...
		private void Pack()
		{
			(var texture, var uvs) = PackingUtilities.PackTight(textures, choiceHeuristic, initialBinWidth, initialBinHeight);
