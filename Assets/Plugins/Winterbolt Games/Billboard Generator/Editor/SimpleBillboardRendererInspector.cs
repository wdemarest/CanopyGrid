...
namespace WinterboltGames.BillboardGenerator.Editor
{
	...
	internal sealed class SimpleBillboardRendererInspector : UnityEditor.Editor
	{
		...
		{
			var useBillboardTargetProperty = serializedObject.FindProperty("useBillboardTarget");
			...
			else _ = EditorGUILayout.PropertyField(serializedObject.FindProperty("target"));

			_ = EditorGUILayout.PropertyField(useBillboardTargetProperty);

			var useAlternativeWorkflowProperty = serializedObject.FindProperty("useAlternativeWorkflow");
			...
			else _ = EditorGUILayout.PropertyField(serializedObject.FindProperty("material"));
