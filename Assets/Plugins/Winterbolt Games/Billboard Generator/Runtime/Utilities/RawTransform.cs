...
namespace WinterboltGames.BillboardGenerator.Runtime.Utilities
{
	...
	/// </summary>
	public readonly ref struct RawTransform
	{
		/// <summary>
		...
		public RawTransform RotateTransform(in RawTransform transform, in Vector3 axis, float angle)
		{
			...
			var direction = angleAxis * (transform.Position - Position);

			var newPosition = Position + direction;

			var newRotation = transform.Rotation * (Quaternion.Inverse(transform.Rotation) * angleAxis * transform.Rotation);
